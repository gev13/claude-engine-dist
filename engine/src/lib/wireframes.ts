...
export const CARD_GRID_WIREFRAMES: Record<CardGridVariant, readonly Shape[]> = {
  ...
  mediaRows: [
    ['panel', 4, 6, 152, 26, 2], ['img', 4, 6, 60, 26, 2], ['txt', 72, 11, 8, 1, 3], ['big', 72, 15, 50, 1], ['txt', 72, 21, 70, 2, 3], ['circ', 80, 28, 1.6],
    ['panel', 4, 37, 152, 26, 2], ['img', 4, 37, 60, 26, 2], ['txt', 72, 42, 8, 1, 3], ['big', 72, 46, 50, 1], ['txt', 72, 52, 70, 2, 3], ['circ', 80, 59, 1.6],
    ['panel', 4, 68, 152, 26, 2], ['img', 4, 68, 60, 26, 2], ['txt', 72, 73, 8, 1, 3], ['big', 72, 77, 50, 1], ['txt', 72, 83, 70, 2, 3], ['circ', 80, 90, 1.6],
  ],
};
...
export const BLOCK_WIREFRAMES: Record<BlockType, readonly Shape[]> = {
  ...
  categoryIndex: [
    ['big', 8, 8, 60, 1],
    ...[[8, 22], [82, 22], [8, 50], [82, 50], [8, 78], [82, 78]].flatMap(([x, y]): Shape[] => [['panel', x!, y!, 70, 24, 2], ['acc', x! + 5, y! + 5, 6, 2, 0], ['txt', x! + 5, y! + 10, 34, 1, 3, 'ink'], ['txt', x! + 5, y! + 16, 56, 2, 3]]),
  ],
  toc: [
